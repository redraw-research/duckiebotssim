...
void UAddSensorCommand::Execute() {
	UE_LOG(LogDuckiebotsSim, Log, TEXT("UAddSensorCommand::Add sensor"));
	...
	if (GameTarget == nullptr) {
		UE_LOG(LogDuckiebotsSim, Warning, TEXT("UCommand::Target is not a UHolodeckGameMode*. UAddSensorCommand::Sensor not added."));
		return;
	}

	UWorld* World = Target->GetWorld();
	if (World == nullptr) {
		UE_LOG(LogDuckiebotsSim, Warning, TEXT("UAddSensorCommand::Execute found world as nullptr. Sensor not added."));
		return;
	}
	...
	static USensorMapType SensorMap = {
										...
										{ "DuckiebotsLoopStatusSensor", UDuckiebotsLoopStatusSensor::StaticClass() },
										{ "DuckiebotsSemanticMaskCamera", UDuckiebotsSemanticMaskCamera::StaticClass() },
	};
